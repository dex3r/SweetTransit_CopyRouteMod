...
namespace ModuleInitializerInjector
{
    /// <summary>
    /// Injector module
    /// </summary>
    internal class Injector
    {
        ...
        private void WriteAssembly(string assemblyFile, string keyfile)
        {
            ...
            string outputFile = assemblyFile + "_output.dll";
            
            InjectionTargetAssembly.Write(outputFile, writeParams);
            InjectionTargetAssembly.Dispose();

            File.Copy(outputFile, assemblyFile, true);
